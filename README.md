...
Facktry is an autonomous model-training harness. The repository is currently in the design and pre-implementation stage.
...
No runtime package has been implemented yet. Begin with Phase 00 in the codebase implementation steps. The local `reference_repos/` directory contains prior-art repositories and is intentionally excluded from version control.
